        ...
        <div className = 'container-sm d-flex flex-wrap justify-content-center' style = {{maxWidth:'800px'}}>
            {
                Object.values(sports).map(sport => (
                    ...
                    <div className="card p-2 m-2 col-5 rounded" style = {{borderWidth:'5px', borderRadius:'10%'}}>
                        {icons[sport.sport_id]}
                        <div className="card-body">
                            <a onClick={ () => setSport(sport.sport_id)} href="#" className="stretched-link btn btn-primary w-100">{sport.name} </a>
                        </div>
                    </div>
